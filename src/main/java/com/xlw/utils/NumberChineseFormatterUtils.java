...
public class NumberChineseFormatterUtils {
    public static void main(String[] args) {
        String amountStr = "140,000.00";
        System.out.println(format(amountStr, true, true));
    }
     ...
     * @return 中文
     */
    public static String format(String amountStr, boolean isUseTraditional, boolean isMoneyMode) {
