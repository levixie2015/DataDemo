...
public class ExcelUtils {
    public static void write(List<PaymentPlanDemo> dataList, String sheetName, String fileName) {
        // 创建一个新的工作簿
        ...
        for (int i = 0; i < dataList.size(); i++) {
            PaymentPlanDemo data = dataList.get(i);
...
/**
    ...
    private static void setFirstRow(Sheet sheet, int currentData, PaymentPlanDemo data) {
...
/**
    ...
    private static void setSecondRow(Workbook workbook, Sheet sheet, int currentData, PaymentPlanDemo data) {
...
/**
    ...
    private static void setThirdRow(Workbook workbook, Sheet sheet, int currentData, PaymentPlanDemo data) {
        ...
        cellStyle.setFont(font);
        // 设置水平靠右
        cellStyle.setAlignment((short) 3);//HorizontalAlignment.RIGHT
        // 设置垂直居中
        cellStyle.setVerticalAlignment((short) 1);//VerticalAlignment.CENTER
...
/**
    ...
    private static void setFourthRow(Workbook workbook, Sheet sheet, int currentData, PaymentPlanDemo data) {
...
/**
    ...
    private static void setFifthRow(Workbook workbook, Sheet sheet, int currentData, PaymentPlanDemo data) {
        CellStyle cellStyle = workbook.createCellStyle();
        Font font = workbook.createFont();
        cellStyle.setFont(font);
        //创建一个字体对象并设置其属性
        ...
        cellStyle.setFont(font);
        // 设置水平居中
        cellStyle.setAlignment((short) 2);//HorizontalAlignment.CENTER
        // 设置垂直居中
        cellStyle.setVerticalAlignment((short) 1);//VerticalAlignment.CENTER
        cellStyle.setBorderTop((short) 1);//BorderStyle.THIN
        cellStyle.setBorderLeft((short) 1);//BorderStyle.THIN
        cellStyle.setBorderRight((short) 1);//BorderStyle.THIN
        cellStyle.setBorderBottom((short) 1);//BorderStyle.THIN
...
/**
    ...
    private static void setSixthRow(Workbook workbook, Sheet sheet, int currentData, PaymentPlanDemo data) {
        CellStyle cellStyle = workbook.createCellStyle();
        Font font = workbook.createFont();
        cellStyle.setFont(font);
        //创建一个字体对象并设置其属性
...
/**
    ...
    private static void setSeventhRow(Workbook workbook, Sheet sheet, int currentData, PaymentPlanDemo data) {
        CellStyle cellStyle = workbook.createCellStyle();
        Font font = workbook.createFont();
        cellStyle.setFont(font);
        //创建一个字体对象并设置其属性
...
/**
    ...
    private static void setEighthRow(Workbook workbook, Sheet sheet, int currentData, PaymentPlanDemo data) {
        CellStyle cellStyle = workbook.createCellStyle();
        Font font = workbook.createFont();
        cellStyle.setFont(font);
        //创建一个字体对象并设置其属性
...
/**
    ...
    private static int setNinthRow(Workbook workbook, Sheet sheet, int currentData, PaymentPlanDemo data) {
        CellStyle cellStyle = workbook.createCellStyle();
        Font font = workbook.createFont();
        cellStyle.setFont(font);
        //创建一个字体对象并设置其属性
